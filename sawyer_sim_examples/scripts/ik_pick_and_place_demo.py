...
def load_gazebo_models(table_pose=Pose(position=Point(x=0.75, y=0.0, z=0.0)),
                       ...
                       kinect_pose = Pose( position=Point(x=-1.25, y=0.0, z=1), orientation=Quaternion(*tf.transformations.quaternion_from_euler(0, 0, 0))),
    ...
    try:
        ...
        resp_urdf = spawn_urdf("wood_cube_2_5cm", block_xml, "/",
    ...
    try:
        spawn_urdf = rospy.ServiceProxy('/gazebo/spawn_sdf_model', SpawnModel)
        resp_urdf = spawn_urdf("tube_2_25cm", tube_xml, "/",
